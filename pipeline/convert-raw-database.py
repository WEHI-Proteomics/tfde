...
parser.add_argument('-nfb','--number_of_frames_in_batch', type=int, default=100, help='The number of frames in a batch.', required=False)
...
parser.add_argument('-ssm', '--small_set_mode', type=bool, help='A small subset of the data for testing purposes.', default=False)
