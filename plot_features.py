...
ax1.plot(clusters_v[clusters_v_feature_indices,CLUSTER_FRAME_ID_IDX], clusters_v[clusters_v_feature_indices,CLUSTER_INTENSITY_SUM_IDX], 'o', markerfacecolor='orange', markeredgecolor='black', markeredgewidth=0.0, markersize=6)
