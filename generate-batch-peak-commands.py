...
for i in range(NUMBER_OF_BATCHES):
    ...
    print("nohup python -u ./otf-peak-detect/peak-detect-intensity-descent.py -db {} -fl {} -fu {} -ts databases/{}.sqlite >logs/peak-{}.log &".format(args.database_name, start_frame, end_frame, range_str, range_str))
