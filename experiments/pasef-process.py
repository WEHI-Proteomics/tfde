...
def collate_spectra_for_feature(feature_a, ms2_a):
    ...
    params = {}
    params["TITLE"] = "RawFile: {} Charge: {} FeatureIntensity: {} Feature#: {} RtApex: {} Precursor: {}".format(os.path.basename(CONVERTED_DATABASE_NAME).split('.')[0], int(feature_a[1]), int(feature_a[4]), int(feature_a[0]), round(feature_a[3],2), int(feature_a[5]))
