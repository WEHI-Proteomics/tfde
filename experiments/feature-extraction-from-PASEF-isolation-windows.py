...
def deconvolute_ms2_peaks_for_feature(binned_ms2_df):
    ...
    ms2_deconvoluted_peaks, _ = deconvolute_peaks(ms2_peaks_l, averagine=averagine.peptide, charge_range=(1,5), scorer=scoring.LeastSquaresFitter(score_threshold=0.5), truncate_after=0.8)
