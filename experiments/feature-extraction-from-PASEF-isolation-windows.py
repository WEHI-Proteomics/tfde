...
def deconvolute_ms2_peaks_for_feature(binned_ms2_df):
    ...
    ms2_deconvoluted_peaks, _ = deconvolute_peaks(ms2_peaks_l, averagine=averagine.peptide, charge_range=(1,5), scorer=scoring.MSDeconVFitter(minimum_score=10, mass_error_tolerance=0.1), truncate_after=0.95)
...
if args.new_mgf_spectra:
    ...
    if args.test_mode:
        ms1_deduped_df[ms1_deduped_df.feature_id == 822]
