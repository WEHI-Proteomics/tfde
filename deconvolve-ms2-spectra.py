...
for feature_list_idx in range(0,len(feature_list_df)):
    ...
    print("Generating Hardklor file for feature {} ({}% complete)".format(feature_id, round((feature_id-args.feature_id_lower)/(args.feature_id_upper-args.feature_id_lower)*100,1)))
