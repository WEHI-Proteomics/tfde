...
parser.add_argument('-ml','--mz_lower', type=int, help='Lower limit for m/z.', required=False)
parser.add_argument('-mu','--mz_upper', type=int, help='Upper limit for m/z.', required=False)
