...
def task_make_copies():
    ...
    def set_up_target_dir():
        ...
        target_directory_name = '/media/big-ssd/results-{}-3did/features-minvi-{}-{}'.format(config['experiment_name'], config['experiment_name'], config['minvi'], d.strftime("%Y-%m-%d-%H-%M-%S"))
