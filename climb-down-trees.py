        ...
        for scan in range(scan_lower, scan_upper+1):
            ...
            while len(points_v) > 0:
                ...
                if len(nearby_point_indices) > noise_threshold:
                    ...
                    pointId += 1
                    feature_count_for_scan += 1
                    high_intensity = max(high_intensity, centroid_intensity)
                    low_intensity = min(low_intensity, centroid_intensity)
