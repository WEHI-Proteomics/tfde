...
MIN_MZ_BETWEEN_POINTS = 0.025
MIN_NUMBER_OF_MZ_POINTS_BETWEEN_PEAKS = int(round(MIN_MZ_BETWEEN_POINTS / MZ_INCREMENT))
SOURCE_SQLITE_FILE = "\\temp\\161117-TIMS_TuneMix_MS_AutoMSMS-frames-th-0-1-1565-V4.sqlite"
DEST_SQLITE_FILE = "\\temp\\summed-1-10-5-161117-TIMS_TuneMix_MS_AutoMSMS-frames-th-0-1-1565-V4.sqlite"
...
for base_frame in range(FRAME_START, FRAME_END, FRAMES_TO_SUM):
    ...
    for scan in range(scan_min, scan_max+1):
        ...
        if len(truncated_sum_vector) > 0:
            ...
            indexes = peakutils.indexes(truncated_sum_vector, thres=0.01, min_dist=MIN_NUMBER_OF_MZ_POINTS_BETWEEN_PEAKS)
