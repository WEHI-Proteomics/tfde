    ...
    while anchor_point_s.intensity >= MIN_ANCHOR_POINT_INTENSITY:
        ...
        if (number_of_point_clusters > 0) and (anchor_point_cluster >= 0):
            ...
            if (number_of_isotope_clusters > 0) and (anchor_point_isotope_cluster >= 0):
                ...
                precursor_cuboids_l.append((mz_lower, mz_upper, scan_lower, scan_upper, rt_lower, rt_upper, anchor_point_s.intensity, anchor_point_s.mz, anchor_point_s.scan, anchor_point_s.retention_time_secs, number_of_isotope_clusters, number_of_point_clusters_in_anchor_isotope_cluster))
...
precursor_cuboids_df = pd.DataFrame(cuboids_l, columns=['mz_lower', 'mz_upper', 'scan_lower', 'scan_upper', 'rt_lower', 'rt_upper', 'anchor_point_intensity', 'anchor_point_mz', 'anchor_point_scan', 'anchor_point_retention_time_secs', 'number_of_isotope_clusters', 'number_of_isotopes'])
