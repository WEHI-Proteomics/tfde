...
for i in range(args.number_of_batches):
    ...
    print("nohup python -u ./feature-region-ms2-sum-frames.py -db {} -fl {} -fu {} > ../logs/{}-ms2-feature-region-sum-batch-{}-{}-{}.log 2>&1 &".format(args.database_name, first_feature_id, last_feature_id, args.database_name, i, first_feature_id, last_feature_id))
